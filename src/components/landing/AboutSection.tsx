...
const achievements = [
  { icon: <Headphones className="w-6 h-6" />, label: "Лет в продакшене", value: "7+" },
  { icon: <Music className="w-6 h-6" />, label: "Авторских битов", value: "800+" },
  { icon: <Mic2 className="w-6 h-6" />, label: "Коллабораций", value: "150+" },
  { icon: <Award className="w-6 h-6" />, label: "Стилей и жанров", value: "12+" },
];
    ...
    <section ref={ref} id="about" className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Кто за пультом</h2>
            <p className="text-lg mb-6 text-zinc-300">
              Я — битмейкер и саунд-продюсер с 7-летним опытом. Работаю на стыке жанров: трэп, дрилл, лоу-фай, R&B и хип-хоп. Каждый бит — это ручная работа, без шаблонов и готовых пресетов.
            </p>
            <p className="text-lg mb-8 text-zinc-300">
              Мои биты используют артисты из России, СНГ и Европы. Если ты ищешь звук, который выделит тебя из толпы — ты попал по адресу. Выбирай лицензию, скачивай и записывай.
            </p>
