  ...
  return (
    <section id="contact" ref={ref} className="py-20 bg-zinc-900 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-zinc-400 text-center mb-10 max-w-lg mx-auto">Хочешь кастомный бит, коллаборацию или есть вопросы по лицензии? Пиши — отвечу в течение суток.</p>
        <div
